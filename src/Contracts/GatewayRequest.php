...
interface GatewayRequest
{
    ...
    //We neeed to think another name for ordernum or pick it off the project
    public function charge(PaymentType $payment, int $amount, string $description, int $ordernum): GatewayResponse;
